"""
Django settings for AdvBoard project.
...
SECRET_KEY = 'django-insecure-vq(-crdr3-3j&4ukv6&%$_)jqqy8b(u==8hx8lha@01_1p5jo('
...
WSGI_APPLICATION = 'AdvBoard.wsgi.application'
...
ACCOUNT_FORMS = {'signup': 'sign.forms.SignupForm'}
