...
urlpatterns = [
    ...
    path('<int:pk>/delete/', PostDeleteView.as_view(), name='post_delete'),  # Ссылка на создание товара
    path('<int:pk>/edit/', PostEditView.as_view(), name='post_edit'),  # Ссылка на создание товара
]